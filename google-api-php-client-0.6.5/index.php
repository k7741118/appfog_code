...
//print_r($service->query->sql("delete from 1ITie1zUE5YsfqYdPxQ88hXOrIPfgWl0qJ6i-Lhk"));
print_r($service->query->sql("select * from 1ITie1zUE5YsfqYdPxQ88hXOrIPfgWl0qJ6i-Lhk"));
